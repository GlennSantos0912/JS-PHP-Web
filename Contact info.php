...
<div id="headercontainer">
  ...
  <h1>Glenn Patrick Santos </h1>
    ...
    <div id="wrapper">
        <div id="content">
            <h1>CONTACT ME:</h1>
			<p><strong>By Phone: +639669839659<strong></p>
			<p><strong>By Social media:<strong></p>
        <p>FACEBOOK-Glenn Patrick Santos</p>
        <p>INSTAGRAM-glennsantosss</p>
        <p><strong>Email me at: glennsantos0912@gmail.com<strong></p>
        </div>
    </div>
<div id="rspcontainer">
